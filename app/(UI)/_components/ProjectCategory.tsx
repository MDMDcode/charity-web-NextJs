              ...
              <div className="space-y-10">
                ...
                <div className="text-center">
                  <button
                    ...
                    className="inline-flex items-center gap-2 border-2 border-[#009689] text-[#009689] hover:bg-[#009689] hover:text-white font-bold px-10 py-3 rounded-full transition-all shadow-md"
                  >
                    {activeTab === ALL_TAB
